...
int initialize( int xcoor, int ycoor ){
...
*/
struct Neighborhood neighborhoodOf( int ** matrix, int xcoor, int ycoor){
...
*/
int nextState( int ** matrix, int xcoor, int ycoor ){
...
int main(int argc, char const **argv)
{
    ...
    int ** in = ( int **) malloc(Dy*sizeof( int *));
    int ** out = ( int **) malloc(Dy*sizeof( int *));
    int i = 0;
    for (i=0; i<Dx; ++i){ 
        in[i] = ( int *) malloc(Dx*sizeof(int));
        out[i] = ( int *) malloc(Dx*sizeof(int));
    }
